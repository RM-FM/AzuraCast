...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap-release-assets/releases/download/rolling-release-v2.4.x/liquidsoap-c207924_2.4.3-debian-trixie-ocaml4.14.2-1_${ARCHITECTURE}.deb"
